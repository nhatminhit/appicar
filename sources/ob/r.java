...
public final class r {
    ...
    public static String b(int i10, int i11, String str) throws m {
        if (str.length() >= i10) {
    ...
    public static String c(int i10, int i11, String str) throws m {
        String substring = str.substring(0, i10);
