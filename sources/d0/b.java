...
public class b {
    ...
    public static final ThreadLocal<Matrix> f5992a = new ThreadLocal<>();

    /* renamed from: b  reason: collision with root package name */
    public static final ThreadLocal<RectF> f5993b = new ThreadLocal<>();
    ...
    public static void c(ViewGroup viewGroup, View view, Rect rect) {
        ThreadLocal<Matrix> threadLocal = f5992a;
        ...
        ThreadLocal<RectF> threadLocal2 = f5993b;
