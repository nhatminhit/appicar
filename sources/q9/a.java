...
public final class a {
    ...
    public static android.util.AttributeSet a(@d.m0 android.content.Context r3, @d.i1 int r4, @d.m0 java.lang.CharSequence r5) {
        /*
        ...
        L_0x004a:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: q9.a.a(android.content.Context, int, java.lang.CharSequence):android.util.AttributeSet");
    }

    @TargetApi(21)
    public static void b(@o0 RippleDrawable rippleDrawable, int i10) {
        rippleDrawable.setRadius(i10);
    }

    @o0
    public static PorterDuffColorFilter c(@m0 Drawable drawable, @o0 ColorStateList colorStateList, @o0 PorterDuff.Mode mode) {
