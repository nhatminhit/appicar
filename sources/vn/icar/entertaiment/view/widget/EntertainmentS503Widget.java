...
public class EntertainmentS503Widget extends BaseAppWidgetProvider {
    @SuppressLint({"RemoteViewLayout"})
    public static void k(Context context, AppWidgetManager appWidgetManager, int i10) {
        RemoteViews remoteViews = new RemoteViews(context.getPackageName(), R.layout.widget_entertainment_s503);
        remoteViews.setOnClickPendingIntent(R.id.root_layout, PendingIntent.getActivity(context, 0, new Intent(context, HomeActivity.class), BaseAppWidgetProvider.b()));
        ...
        if (bitmap == null) {
            remoteViews.setImageViewResource(R.id.img_thumbnail, R.drawable.ic_img_s503);
        } else {
            remoteViews.setImageViewBitmap(R.id.img_thumbnail, BaseAppWidgetProvider.d(BaseAppWidgetProvider.a(bitmap), (int) context.getResources().getDimension(R.dimen.size20dp)));
        }
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent != null && intent.getAction() != null) {
            ...
            if (action.equals("vn.icar.entertainment.widget.REFRESH")) {
                ...
                for (int k10 : instance.getAppWidgetIds(new ComponentName(context, EntertainmentS503Widget.class))) {
