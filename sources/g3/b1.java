...
public class b1 implements d1 {
    ...
    public static class a extends ViewGroup {
        ...
        public ViewParent f(int i10, int i11, Rect rect) {
            if (!(this.O instanceof ViewGroup) || T == null) {
                return null;
            }
            try {
                e(new int[2]);
        ...
        public boolean verifyDrawable(@d.m0 android.graphics.drawable.Drawable r2) {
            ...
            L_0x0014:
                return r2
            */
            throw new UnsupportedOperationException("Method not decompiled: g3.b1.a.verifyDrawable(android.graphics.drawable.Drawable):boolean");
        }
    }

    public b1(Context context, ViewGroup viewGroup, View view) {
        this.f7659a = new a(context, viewGroup, view, this);
    }
    ...
    public static b1 e(View view) {
        ...
        return new u0(f10.getContext(), f10, view);
    }
    ...
    public void a(@m0 Drawable drawable) {
        this.f7659a.a(drawable);
    }

    public void b(@m0 Drawable drawable) {
        this.f7659a.g(drawable);
    }
}
