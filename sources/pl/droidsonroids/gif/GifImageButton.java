...
public class GifImageButton extends ImageButton {
    ...
    public GifImageButton(Context context, AttributeSet attributeSet, int i10) {
        super(context, attributeSet, i10);
        a(l.c(this, attributeSet, i10, 0));
    }

    @t0(21)
    public GifImageButton(Context context, AttributeSet attributeSet, int i10, int i11) {
