...
public final class b {
    ...
    public static final Type[] f19852a = new Type[0];
    ...
    public static final class a implements GenericArrayType, Serializable {
        ...
        public String toString() {
            return b.u(this.O) + c0.f21474n;
        }
    }

    /* renamed from: ja.b$b  reason: collision with other inner class name */
    public static final class C0332b implements ParameterizedType, Serializable {
        public static final long R = 0;
        public final Type O;
        public final Type P;
        public final Type[] Q;

        public C0332b(Type type, Type type2, Type... typeArr) {
            ...
            this.O = type == null ? null : b.b(type);
            this.P = b.b(type2);
        ...
        public int hashCode() {
            return (Arrays.hashCode(this.Q) ^ this.P.hashCode()) ^ b.m(this.O);
        }
        ...
        public String toString() {
            ...
            sb2.append(b.u(this.P));
            sb2.append("<");
            sb2.append(b.u(this.Q[0]));
            for (int i10 = 1; i10 < length; i10++) {
                sb2.append(", ");
                sb2.append(b.u(this.Q[i10]));
            }
            sb2.append(">");
            return sb2.toString();
        }
    ...
    public static Type b(Type type) {
        if (type instanceof Class) {
            ...
            return new C0332b(parameterizedType.getOwnerType(), parameterizedType.getRawType(), parameterizedType.getActualTypeArguments());
    ...
    public static ParameterizedType o(Type type, Type type2, Type... typeArr) {
        return new C0332b(type, type2, typeArr);
    }
    ...
    public static java.lang.reflect.Type q(java.lang.reflect.Type r9, java.lang.Class<?> r10, java.lang.reflect.Type r11, java.util.Map<java.lang.reflect.TypeVariable<?>, java.lang.reflect.Type> r12) {
        ...
        L_0x00dd:
            ...
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: ja.b.q(java.lang.reflect.Type, java.lang.Class, java.lang.reflect.Type, java.util.Map):java.lang.reflect.Type");
    }
