...
public class c {
    public static void a(ViewGroup.LayoutParams layoutParams, String str) {
        ...
        String str2 = ".(" + stackTraceElement.getFileName() + ":" + stackTraceElement.getLineNumber() + ") " + str + q.a.R;
        System.out.println(" >>>>>>>>>>>>>>>>>>. dump " + str2 + q.a.R + layoutParams.getClass().getName());
                    ...
                    if (!(obj2 instanceof Integer) || !obj2.toString().equals("-1")) {
                        if (!(obj2 instanceof Integer) || !obj2.toString().equals("0")) {
                            if (!(obj2 instanceof Float) || !obj2.toString().equals(BuildConfig.VERSION_NAME)) {
                                if (!(obj2 instanceof Float) || !obj2.toString().equals(p.f16199r)) {
    ...
    public static java.lang.String j(android.content.Context r5, int[] r6) {
        ...
        L_0x0072:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: v.c.j(android.content.Context, int[]):java.lang.String");
    }
    ...
    public static void m(String str, String str2, int i10) {
        ...
        for (int i11 = 1; i11 <= min; i11++) {
            ...
            sb2.append(str2);
            sb2.append(str3);
            sb2.append(".(" + stackTrace[i11].getFileName() + ":" + stackTrace[i11].getLineNumber() + ") " + stackTrace[i11].getMethodName());
            sb2.append(str3);
        }
    }
