...
public class o {
    ...
    public static final String f14185b = "org.springframework.";

    /* renamed from: c  reason: collision with root package name */
    public static final String f14186c = "com.mchange.v2.c3p0.";

    /* renamed from: d  reason: collision with root package name */
    public static final Set<String> f14187d;

    /* renamed from: e  reason: collision with root package name */
    public static final o f14188e = new o();

    /* renamed from: a  reason: collision with root package name */
    public Set<String> f14189a = f14187d;
    ...
    static {
        ...
        f14187d = Collections.unmodifiableSet(hashSet);
    }
    ...
    public void b(g gVar, j jVar, c cVar) throws l {
        Class g10 = jVar.g();
        String name = g10.getName();
        if (!this.f14189a.contains(name)) {
            if (!g10.isInterface()) {
                if (name.startsWith(f14185b)) {
                    while (g10 != null && g10 != Object.class) {
                    ...
                    return;
                } else if (!name.startsWith(f14186c) || !name.endsWith("DataSource")) {
                    return;
                }
            } else {
                return;
