...
public final class m {
    ...
    public final List<int[]> f20471a = new ArrayList();

    /* renamed from: b  reason: collision with root package name */
    public final List<String> f20472b = new ArrayList();

    public final void a(int[] iArr, String str) {
        this.f20471a.add(iArr);
    ...
    public String c(String str) {
        ...
        int size = this.f20471a.size();
        for (int i11 = 0; i11 < size && parseInt >= (i10 = iArr[0]); i11++) {
            if ((iArr = this.f20471a.get(i11)).length != 1) {
                i10 = iArr[1];
            }
            if (parseInt <= i10) {
                return this.f20472b.get(i11);
            }
        }
        return null;
    }
