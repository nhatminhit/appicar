...
public final class c0 implements c {
    ...
    public c0(@m0 RelativeLayout relativeLayout, @m0 TextView textView) {
    ...
    public static c0 a(@m0 View view) {
        ...
        if (textView != null) {
            return new c0((RelativeLayout) view, textView);
        }
    ...
    @m0
    public static c0 d(@m0 LayoutInflater layoutInflater, @o0 ViewGroup viewGroup, boolean z10) {
