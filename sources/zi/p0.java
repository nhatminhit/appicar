...
public final class p0 implements c {
    ...
    public p0(@m0 RelativeLayout relativeLayout, @m0 CardView cardView, @m0 ImageView imageView, @m0 ImageView imageView2, @m0 RelativeLayout relativeLayout2, @m0 TextView textView, @m0 TextView textView2, @m0 TextView textView3, @m0 TextView textView4, @m0 RelativeLayout relativeLayout3) {
                                ...
                                if (textView3 != null) {
                                    ...
                                    if (textView4 != null) {
                                        ...
                                        if (relativeLayout2 != null) {
                                            return new p0((RelativeLayout) view, cardView, imageView, imageView2, relativeLayout, textView, textView2, textView3, textView4, relativeLayout2);
                                        }
                                    }
                                }
                            }
    ...
    @m0
    public static p0 c(@m0 LayoutInflater layoutInflater) {
        return d(layoutInflater, (ViewGroup) null, false);
    }

    @m0
    public static p0 d(@m0 LayoutInflater layoutInflater, @o0 ViewGroup viewGroup, boolean z10) {
        View inflate = layoutInflater.inflate(R.layout.item_video_youtube, viewGroup, false);
        if (z10) {
