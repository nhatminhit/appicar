...
public final class a1 implements c {
    ...
    public final RelativeLayout f25143a0;
    @m0

    /* renamed from: b0  reason: collision with root package name */
    public final TextView f25144b0;
    @m0

    /* renamed from: c0  reason: collision with root package name */
    public final TextView f25145c0;
    @m0

    /* renamed from: d0  reason: collision with root package name */
    public final TextView f25146d0;

    public a1(@m0 RelativeLayout relativeLayout, @m0 ImageView imageView, @m0 ImageView imageView2, @m0 ImageView imageView3, @m0 ImageView imageView4, @m0 ImageView imageView5, @m0 ImageView imageView6, @m0 ImageView imageView7, @m0 LinearLayout linearLayout, @m0 LinearLayout linearLayout2, @m0 RelativeLayout relativeLayout2, @m0 RelativeLayout relativeLayout3, @m0 RelativeLayout relativeLayout4, @m0 TextView textView, @m0 TextView textView2, @m0 TextView textView3) {
        ...
        this.f25143a0 = relativeLayout4;
        this.f25144b0 = textView;
        this.f25145c0 = textView2;
        this.f25146d0 = textView3;
    }
                                                ...
                                                if (relativeLayout2 != null) {
                                                    ...
                                                    if (textView != null) {
                                                        ...
                                                        if (textView2 != null) {
                                                            ...
                                                            if (textView3 != null) {
                                                                return new a1(relativeLayout3, imageView, imageView2, imageView3, imageView4, imageView5, imageView6, imageView7, linearLayout, linearLayout2, relativeLayout, relativeLayout2, relativeLayout3, textView, textView2, textView3);
                                                            }
                                                        }
                                                    }
                                                }
    ...
    @m0
    public static a1 c(@m0 LayoutInflater layoutInflater) {
        return d(layoutInflater, (ViewGroup) null, false);
    }

    @m0
    public static a1 d(@m0 LayoutInflater layoutInflater, @o0 ViewGroup viewGroup, boolean z10) {
        View inflate = layoutInflater.inflate(R.layout.widget_entertainment_s5_gold, viewGroup, false);
        if (z10) {
