...
public final class u0 implements c {
    ...
    public final TextView f25207a0;
    @m0

    /* renamed from: b0  reason: collision with root package name */
    public final TextView f25208b0;
    @m0

    /* renamed from: c0  reason: collision with root package name */
    public final TextView f25209c0;
    @m0

    /* renamed from: d0  reason: collision with root package name */
    public final TextView f25210d0;
    @m0

    /* renamed from: e0  reason: collision with root package name */
    public final TextView f25211e0;
    @m0

    /* renamed from: f0  reason: collision with root package name */
    public final LinearLayout f25212f0;
    @m0

    /* renamed from: g0  reason: collision with root package name */
    public final RelativeLayout f25213g0;
    @m0

    /* renamed from: h0  reason: collision with root package name */
    public final RelativeLayout f25214h0;
    @m0

    /* renamed from: i0  reason: collision with root package name */
    public final RelativeLayout f25215i0;
    @m0

    /* renamed from: j0  reason: collision with root package name */
    public final RelativeLayout f25216j0;
    @m0

    /* renamed from: k0  reason: collision with root package name */
    public final ListView f25217k0;

    public u0(@m0 RelativeLayout relativeLayout, @m0 ImageView imageView, @m0 ImageView imageView2, @m0 ImageView imageView3, @m0 ImageView imageView4, @m0 ImageView imageView5, @m0 ImageView imageView6, @m0 ImageView imageView7, @m0 ImageView imageView8, @m0 ListView listView, @m0 ProgressBar progressBar, @m0 TextView textView, @m0 TextView textView2, @m0 TextView textView3, @m0 TextView textView4, @m0 TextView textView5, @m0 TextView textView6, @m0 LinearLayout linearLayout, @m0 RelativeLayout relativeLayout2, @m0 RelativeLayout relativeLayout3, @m0 RelativeLayout relativeLayout4, @m0 RelativeLayout relativeLayout5, @m0 ListView listView2) {
        ...
        this.Y = progressBar;
        this.Z = textView;
        this.f25207a0 = textView2;
        this.f25208b0 = textView3;
        this.f25209c0 = textView4;
        this.f25210d0 = textView5;
        this.f25211e0 = textView6;
        this.f25212f0 = linearLayout;
        this.f25213g0 = relativeLayout2;
        this.f25214h0 = relativeLayout3;
        this.f25215i0 = relativeLayout4;
        this.f25216j0 = relativeLayout5;
        this.f25217k0 = listView2;
    }

    @m0
    public static u0 a(@m0 View view) {
        View view2 = view;
                                                                                ...
                                                                                if (relativeLayout2 != null) {
                                                                                    ...
                                                                                    if (relativeLayout3 != null) {
                                                                                        ...
                                                                                        if (relativeLayout4 != null) {
                                                                                            ...
                                                                                            if (listView2 != null) {
                                                                                                return new u0((RelativeLayout) view2, imageView, imageView2, imageView3, imageView4, imageView5, imageView6, imageView7, imageView8, listView, progressBar, textView, textView2, textView3, textView4, textView5, textView6, linearLayout, relativeLayout, relativeLayout2, relativeLayout3, relativeLayout4, listView2);
                                                                                            }
                                                                                        }
                                                                                    }
                                                                                }
    ...
    @m0
    public static u0 c(@m0 LayoutInflater layoutInflater) {
        return d(layoutInflater, (ViewGroup) null, false);
    }

    @m0
    public static u0 d(@m0 LayoutInflater layoutInflater, @o0 ViewGroup viewGroup, boolean z10) {
        View inflate = layoutInflater.inflate(R.layout.widget_entertainment_alusa, viewGroup, false);
        if (z10) {
