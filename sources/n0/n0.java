...
public class n0 {
    ...
    public static final String f10729a = "PathParser";
    ...
    public static class b {
        ...
        public b(b bVar) {
            ...
            float[] fArr = bVar.f10733b;
            this.f10733b = n0.c(fArr, 0, fArr.length);
        }
        ...
        public static void a(android.graphics.Path r25, float[] r26, char r27, char r28, float[] r29) {
            ...
            L_0x02fa:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: n0.n0.b.a(android.graphics.Path, float[], char, char, float[]):void");
        }
        ...
        public static void e(b[] bVarArr, Path path) {
            ...
            for (int i10 = 0; i10 < bVarArr.length; i10++) {
                b bVar = bVarArr[i10];
                a(path, fArr, c10, bVar.f10732a, bVar.f10733b);
                c10 = bVarArr[i10].f10732a;
            }
        }
        ...
        public void d(b bVar, b bVar2, float f10) {
            ...
            while (true) {
                float[] fArr = bVar.f10733b;
                if (i10 < fArr.length) {
                    this.f10733b[i10] = (fArr[i10] * (1.0f - f10)) + (bVar2.f10733b[i10] * f10);
                    i10++;
                } else {
                    return;
                }
    ...
    public static boolean b(@o0 b[] bVarArr, @o0 b[] bVarArr2) {
        if (bVarArr == null || bVarArr2 == null || bVarArr.length != bVarArr2.length) {
            return false;
        }
        for (int i10 = 0; i10 < bVarArr.length; i10++) {
            b bVar = bVarArr[i10];
            char c10 = bVar.f10732a;
            b bVar2 = bVarArr2[i10];
            if (c10 != bVar2.f10732a || bVar.f10733b.length != bVar2.f10733b.length) {
                return false;
            }
        }
        return true;
    ...
    public static b[] d(String str) {
        ...
        while (i10 < str.length()) {
            int j10 = j(str, i10);
            String trim = str.substring(i11, j10).trim();
            if (trim.length() > 0) {
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static void g(java.lang.String r8, int r9, n0.n0.a r10) {
        /*
            r0 = 0
            r10.f10731b = r0
            r1 = r9
        ...
        L_0x003b:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: n0.n0.g(java.lang.String, int, n0.n0$a):void");
    }
    ...
    public static void k(b[] bVarArr, b[] bVarArr2) {
        for (int i10 = 0; i10 < bVarArr2.length; i10++) {
            bVarArr[i10].f10732a = bVarArr2[i10].f10732a;
            int i11 = 0;
            while (true) {
                float[] fArr = bVarArr2[i10].f10733b;
                if (i11 >= fArr.length) {
                    break;
                }
                bVarArr[i10].f10733b[i11] = fArr[i11];
                i11++;
            }
        }
    }
